    ...
    <div className="max-w-5xl mx-auto px-4 py-10 pb-16">
      <div className="text-center mb-10">
        ...
        <p className="text-warm-500 text-lg">
          Koi bhi sawaal ho ya order karna ho — hum yahan hain
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
        {[
          ...
          },
          {
            icon: <FiMail />,
            title: "Email",
            value: "shyamphotogallery@gmail.com",
            sub: "24 ghante mein reply",
          },
          {
            icon: <FiMapPin />,
            title: "Address",
            value: "Shyam Photo Gallery",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-white/80 text-sm">
              Custom frames, gifts, t-shirts ya bouquet ka order dena ho toh
              yahan click karein
            </p>
        ...
        >
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder={
                activeType === "order"
                  ? "Kya order karna chahte hain? Size, quantity, special requirements batayein..."
